...
public class ConsumeJSON extends Application {
    ...
    private ObservableList<Car> listOfPeople;
    //private static final String JSON_URL = "https://api.myjson.com/bins/3jwmh";
    private static final String JSON_URL = "http://localhost:8080/cool-cars";
    ...
    public void start(Stage stage) throws Exception {
        ...
        fetchList.setOnSucceeded(new EventHandler<WorkerStateEvent>() {
            ...
            public void handle(WorkerStateEvent t) {
                ...
                for(Car p : listOfPeople){
                    System.out.println("PeopleOnSO "+p.getName()+" "+p.getId());
                }
...
//                stage.sizeToScene();
     ...
     * @param <V>
     */
    private Task<List<Car>> fetchList = new Task() {
        @Override
        protected List<Car> call() throws Exception {
            ...
            try {
                ...
                list = new Gson().fromJson(readUrl(JSON_URL), new TypeToken<List<Car>>() {
                }.getType());
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private class PeopleOnSO {
        ...
        public PeopleOnSO(String name, String like, String imageUrl, String price, String productId){
